      ...
      try {
        ...
        if (response.ok) {
          ...
          if (data.admintoken) {
            ...
            console.log("Token saved:", data.admintoken);
          } else {
      ...
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="hidden md:flex md:w-1/2 flex-col items-center justify-center bg-gradient-to-br from-blue-200 to-blue-400 p-10">
          <div className="w-full flex flex-col items-center">
            ...
            <h2 className="text-2xl font-bold text-blue-700 mt-8 mb-2 text-center">
              Welcome to the Admin Portal!
            </h2>
            <p className="text-blue-900 text-center text-sm max-w-xs mb-4">
              Manage your platform, view analytics, and access exclusive admin
              features with Gadi Becho.
            </p>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8">
          <div className="w-full max-w-md mx-auto rounded-2xl p-8 relative">
            {/* Welcome badge */}
            <div className="absolute -top-6 left-8 bg-blue-500 text-white px-6 py-2 rounded-full font-semibold shadow-md text-sm">
              Welcome back
            </div>
            <h3 className="text-xl font-semibold text-blue-700 mb-6 mt-6 text-center md:text-left">
