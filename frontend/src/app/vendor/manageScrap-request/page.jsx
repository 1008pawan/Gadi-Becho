...
const ManageRequest = () => {
  ...
  return (    <div className=''>
      <div className='bg-gray-100 min-h-screen py-20'>
        <h1 className='text-4xl font-bold py-5 text-center text-gray-800'>Approved Requests</h1>
                  ...
                  <tbody className='divide-y divide-gray-200'>
                    {requestList.map((request) => (
                      <tr key={request._id} className='hover:bg-gray-50'>
                        <td className='px-6 py-4 whitespace-nowrap text-sm text-gray-500'>{request.reqNumber}</td>
                        <td className='px-6 py-4 whitespace-nowrap'>
                          <div>
                            <p className="text-sm font-medium text-gray-900">{request.fullName}</p>
                            <p className="text-sm text-gray-500">{request.vehicleLocation}</p>
                          </div>
                        </td>
